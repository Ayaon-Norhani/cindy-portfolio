...
const processes: Process[] = [
	{
		...
		steps: ['Requirements gathering and process documentation', 'Workflow optimization and task coordination', 'Tool implementation and functionality testing'],
	},
	{
		title: 'Development',
		colorClasses: {
		...
		steps: ['Supporting technical planning and documentation', 'Agile development with sprint planning and task coordination', 'Continuous testing and tracking team progress'],
	},
	{
		title: 'Launch & Growth',
		colorClasses: {
		...
		steps: ['Coordinating software deployment & release schedules', 'Implementing monitoring tools and performance logs', 'Regular updates and feature enhancements'],
	},
];

const DevelopmentProcess = () => {
	return (
		<section id='development process' className="py-16 md:py-20 relative">
			<div className="container mx-auto px-4">
				...
				A systematic approach to delivering reliable software solutions and seamless administrative support
				</p>
